...
//INGRESO DE USUARIO
	...
	else
	{
            ...
            if ($row['cat_cod']==1){
                 header("Location:http://dev.appwebpy.com/IVASYS/web/menu.php");
                 
            }else if($row['cat_cod']==3){
                header("Location:http://dev.appwebpy.com/IVASYS/web/menu_usuario.php");
                 
            
            }else if($row['cat_cod']==2){
                 header("Location:http://dev.appwebpy.com/IVASYS/web/menu_supervisor.php");
            }
        }

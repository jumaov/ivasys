...
function Header()
{
   // Select Arial bold 15
    ...
    $this->Cell(80);
    // Framed title
    $this->text(37,19,utf8_decode('Ministerio de Hacienda'));
    $this->SetFont('Arial','',8);
    $this->text(37,24,"Avda. Gral. Artigas 3973 c/ Gral Roa- Tel.: (59521)290 160 -Fax: (595921) 290 873 ");
    $this->text(37,34,"Telefax: (595921) 295 408 e-mail: ivasys@hacienda.gov.py");
    ...
    $conectate=pg_connect("host=dev.appwebpy.com port=5432 dbname=SCP user=postgres password=postgres")
    or die ('Error al conectar a la base de datos');
    $consulta=pg_exec($conectate,"select * from declaraciones where dec_cod=$codfactura");

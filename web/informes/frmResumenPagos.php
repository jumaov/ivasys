...
<head>
    ...
    <title>SCP-INTN- Resumen Pagos</title>
    <!-- Bootstrap Core CSS -->
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                      <h1 class="page-header">Informes - <small>SCP-INTN</small></h1>
                </div>	
            </div>
            <!-- /.row -->
            <div class="row">
				...
				<div class="modal-body">
                                    <form  autocomplete="off" class="form-horizontal" name="agregarform" action="Imp_ResumenPagos.php" method="post" role="form">

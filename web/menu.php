<?php 
    $conectate=pg_connect("host=dev.appwebpy.com port=5432 dbname=ivasys user=postgres password=postgres")or die ('Error al conectar a la base de datos');
?>
<!DOCTYPE html>
<html lang="es">
<head>
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
                            ...
                            <a href="#">
                                <div>
                                    <p>
                                        ...
                                        <span class="pull-right text-muted"><?php echo 10;?> Declaraciones</span>
                                    </p>
                                    <div class="progress progress-striped active">
                                        <div class="progress-bar progress-bar-success" role="progressbar" aria-valuenow="<?php echo 10;?>" aria-valuemin="0" aria-valuemax="<?php echo 100;?>" style="width: <?php echo 10;?>%">
                            ...
                            <a href="#">
                                <div>
                                    <p>
                                        ...
                                        <span class="pull-right text-muted"><?php echo $reprobados;?> Declaraciones</span>
                                    </p>
                                    <div class="progress progress-striped active">
                                        <div class="progress-bar progress-bar-info" role="progressbar" aria-valuenow="<?php echo 2;?>" aria-valuemin="0" aria-valuemax="<?php echo $cantidad;?>" style="width: <?php echo 2;?>%">
			...
			<li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="http://dev.appwebpy.com/IVASYS/web/usuarios/ABMusuario.php">Registros de Usuarios</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        <li>
                            <a href="#"><i class="fa  fa-flickr "></i> TIPO EMPRESA<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="http://dev.appwebpy.com/IVASYS/web/tipo_empresa/ABMtipo.php">Registros de Tipo de Empresas</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
			<li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="http://dev.appwebpy.com/IVASYS/web/empresas/ABMempresa.php"> Registros de Proveedores</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                         <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="http://dev.appwebpy.com/IVASYS/web/conceptos/ABMconcepto.php">Registros de Conceptos</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>

...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                      <h1 class="page-header">Empresas - <small>IVASYS</small></h1>
                </div>	
            </div>
            <!-- /.row -->
            <div class="row">
                        ...
                        <div class="panel-body">
                            <div class="dataTable_wrapper">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                    <?php
                    $query = "select * from empresas em, tipo_empresa tip where em.tip_cod=tip.tip_cod;";
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label  class="col-sm-2 control-label" for="input01">Tipo Empresa</label>
                                            <div class="col-sm-10">
                                                <select name="txtTelefA" class="form-control" id="txtTelefA" required>
                                                    <?php
                                                    //esto es para mostrar un select que trae datos de la BDD
                                                    conexionlocal();
                                                    $query = "Select tip_cod,tip_des from tipo_empresa where tip_estado='t'";
				...
				<div class="modal-body">
					...
					<div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label  class="col-sm-2 control-label" for="input01">Tipo Empresa</label>
                                            <div class="col-sm-10">
                                                <select name="txtTelefM" class="form-control" id="txtTelefM" required>
                                                    <?php
                                                    //esto es para mostrar un select que trae datos de la BDD
                                                    conexionlocal();
                                                    $query = "Select tip_cod,tip_des from tipo_empresa where tip_estado='t'";

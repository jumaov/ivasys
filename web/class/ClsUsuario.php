 ...
 */
    ...
    if  (empty($_POST['txtCodigoE'])){$codigoElim=0;}else{$codigoElim=$_POST['txtCodigoE'];}
		...
		alert("El Usuario ya existe. Intente ingresar otro Usuario");
                window.location="http://dev.appwebpy.com/IVASYS/web/usuarios/ABMusuario.php";
		</script>';
                }else{              
                //se define el Query   
                ...
                //ejecucion del query
                $ejecucion = pg_query($query)or die('Erro 108: '.$query);
                $query = '';
                header("Refresh:0; url=http://dev.appwebpy.com/IVASYS/web/usuarios/ABMusuario.php");
                }
            }
        //si es Modificar    

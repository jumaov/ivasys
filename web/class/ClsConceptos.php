   ...
   conexionlocal();
    ...
    if  (empty($_POST['txtCodigoE'])){$codigoElim=0;}else{$codigoElim=$_POST['txtCodigoE'];}
		...
		alert("El concepto ya existe. Ingrese otro concepto");
                window.location="http://dev.appwebpy.com/IVASYS/web/conceptos/ABMconcepto.php";
		</script>';
                }else{              
                //se define el Query   
                ...
                $query = '';
                header("Refresh:0; url=http://dev.appwebpy.com/IVASYS/web/conceptos/ABMconcepto.php");
